    ...
    <div className="bg-white shadow-lg py-4 px-6 md:w-[80%] md:py-8 md:relative md:left-32 md:top-5 md:mx-auto rounded-md transition-all duration-300 ease-in-out">
      <div className="flex items-center justify-between w-full">
        ...
        <div className="hidden md:flex md:items-center space-x-8">
          <div className="text-center">
            <h1 className="text-sm text-gray-500">Active Doctor:</h1>
      ...
      {isOpen && (
        <div className="md:hidden mt-4">
          ...
          <Link href="/">
            <button 
            className="w-full bg-sky-400 hover:bg-sky-300 py-2 px-4 text-white rounded-lg transition-all duration-300">
              Log out
            </button>
          </Link>
        </div>
