...
const Navbar = ({ email }: { email: string }) => {
  ...
  return (
    <div className="bg-white shadow-lg py-4 px-6 md:w-[82%] md:py-8 md:relative md:left-32 md:top-4 md:mx-auto rounded-md transition-all duration-300 ease-in-out">
